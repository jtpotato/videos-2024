...
export default makeScene2D(function* (view) {
  ...
  view.add(<>
    <Line points={() => [[-400, 0], circle2Pos()]} stroke={"#bbbbbb"} lineWidth={6} end={0} opacity={0} ref={lineRef} lineDash={[32, 32]} lineCap={"round"} />
    ...
    <Circle {...shapeDefaults()} ref={circlesRefMap.circle2} width={32} height={32} x={() => circle2Pos()[0]} y={() => circle2Pos()[1]}>
      <Txt text={() => `d = ${getDistance(-400, 0, circle2Pos()[0], circle2Pos()[1])}px`} {...textDefaults} fontSize={40} x={200} ref={distLabel} />
    </Circle>
  </>)
